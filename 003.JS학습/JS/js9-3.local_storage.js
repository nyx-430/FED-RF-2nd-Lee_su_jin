...
import mFn from './my_function.js';
 ...
 /*************************************************************** 
    ...
    1. 정의 : 
        ...
        스트링데이터 저장소(JS API)
    2. 유지 : 같은 PC, 같은 브라우저(재설치 없이 사용)일 경우 계속 유지됨
        (단, 같은 파일일 지라도 여는 경로에 따라 같은 변수도
...
function localsFn(){
    ...
    if(btxt=="처음"){
        ...
        localStorage.setItem("actor-role","박평호 역");
...
function makeObj(){
    ...
    // 만약 배열 데이터를 직접 넣으려고 하면 로컬쓰는 문자형만 받기 때문에
