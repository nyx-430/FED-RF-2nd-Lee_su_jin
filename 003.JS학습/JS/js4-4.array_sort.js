...
// (4) 정렬 기준 대상 선택 변경시
// -> 정렬 종류 대상 초기화하기("정렬선택"으로 변경!)
mFn.addEvt(cta4, "change", () => {
  // 정렬 종류 첫번째 값은 value가 "0"이므로
  // 이것을 value 에 할당하면 선택 박스값이 첫번째로 변경된다!
  sel4.value = "0";
}); //////////// change 이벤트 함수 ////////////
