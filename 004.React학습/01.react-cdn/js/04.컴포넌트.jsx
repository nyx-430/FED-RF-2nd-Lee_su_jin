...
// 리액트에서는 from 파일명에 "js/jsx"를 생략해도 됨!
...
/************************************************* 
    ...
    [ 첫번째 컴포넌트 만들기! ]
    - 리액트 컴포넌트 이름은 반드시 첫 글자가 대문자로 만든다!
    (안 지키면 적용 안 됨!!!)
...
class GoghWork extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <h2>안녕! 나는 고흐 그림이야!</h2>
        <MakeImage isrc="01.png" ialt="고흐 그림" />
        {/* <img src="./images/01.png" alt="고흐 그림" /> */}
      </React.Fragment>
    );
  }
} /// GoghWork 클래스형 컴포넌트 ///
...
// 출력: 세번째 .root
ReactDOM.render(
  <FavoriteThings color="와인색" food="와인" hobby="와인 마시기" />,
  target[2]
);

// 출력: 네번째 .root
ReactDOM.render(
  <FavoriteThings color="푸르딩딩한 색" food="김치전" hobby="야구 보기" />,
  target[3]
);
...
/*************************************************** 
    ...
    주의 사항이 있으니 참고 바란다!(아래 참고)

***************************************************/

/************************************************* 
[ 바벨을 사용할 때 모듈로 파일 호출시 주의사항! ]
  ____________________________________________
