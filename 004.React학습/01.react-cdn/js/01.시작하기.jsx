...
/* 
    ...
    -> return 키워드 사용은 따옴표 없이 바로 소괄호롤 묶어 사용
    (소괄호 생략 가능!)
    ...
    내보낼 때 하나로 묶는 역할을 하고 실제로 태그를 출력은 안 됨!
...
function MyFirstReact() {
  ...
  return (
    <React.Fragment>
      ...
      <img src="https://cdn1.iconfinder.com/data/icons/programing-development-8/24/react_logo-512.png" alt="이미지" />
      <h2>
        [ 리액트란 무엇인가? ]
        <br />
        ...
        # 가상돔은 실제DOM을 변경하기 전에 메모리상에서 구성하는 가짜 DOM이다! <br />
