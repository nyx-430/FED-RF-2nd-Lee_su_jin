...
function slideFn(selEl) {
  ...
  // 사용자 정의 속성은 반드시 'data-'로 시작해야 함! (W3C규칙)
  ...
  **********************************/
  function chgIndic(isRight) {
    ...
    // 2. 해당 순번 블릿li에 클래스 on넣기
    // 블릿 전체 순회시 해당 순번에 on넣고 나머지는 on빼기
  ...
  **********************************/
  ...
  mFn.addEvt(dtg, "mouseleave", () => {
    ...
    // 단, style위치값 코드는 'px'단위가 있으므로 parseInt 처리!
