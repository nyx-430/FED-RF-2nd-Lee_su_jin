...
export default function Layout() {
  ...
  // 상태관리변수 변경함수도 전달시 콜백처리해야 메모이제이션 됨!
  ...
  // [ 공통 함수 ] ///
  // 1. 라우팅 이동함수 : 라우터 이동 후크인 useNavigate는
  // 다른 useCollback() 후크로 처리할 수 없다!
  const goNav = useNavigate();

  // 따라서 별도의 함수를 만들고 이것을 콜백 처리해준다!
  // 함수 메모 처리 위해 useCollback()에 넣어준다!
